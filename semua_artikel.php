...
<head>
    ...
    <meta name="description" content="Jelajahi semua artikel menarik dan informatif di Portal Artikel. Temukan berbagai topik dari berbagai kategori.">
...
<body>
    ...
    <section class="py-4 bg-light">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="display-5 fw-bold"><i class="fas fa-newspaper text-primary me-2"></i>Semua Artikel</h1>
                    <p class="lead">Jelajahi koleksi lengkap artikel kami dari berbagai kategori</p>
                    <div class="d-flex align-items-center">
                        <span class="badge bg-primary me-2">Total</span>
                        <span class="text-muted"><?php echo $total_articles; ?> artikel tersedia</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4 d-flex justify-content-md-end">
                    <a href="kategori.php" class="btn btn-outline-primary"><i class="fas fa-filter me-1"></i> Filter Kategori</a>
                </div>
            </div>
                        ...
                        <div class="col">
                            <div class="card h-100 border-0 shadow-sm">
                                <div class="position-relative">
                                    <img src="<?php echo !empty($article['gambar']) ? htmlspecialchars($article['gambar']) : 'assets/images/placeholder.jpg'; ?>" class="card-img-top" alt="<?php echo htmlspecialchars($article['judul']); ?>">
